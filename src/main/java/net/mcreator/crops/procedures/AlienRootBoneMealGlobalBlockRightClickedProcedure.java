...
public class AlienRootBoneMealGlobalBlockRightClickedProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				CropsMod.LOGGER.warn("Failed to load dependency world for procedure AlienRootBoneMealGlobalBlockRightClicked!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				CropsMod.LOGGER.warn("Failed to load dependency x for procedure AlienRootBoneMealGlobalBlockRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				CropsMod.LOGGER.warn("Failed to load dependency y for procedure AlienRootBoneMealGlobalBlockRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				CropsMod.LOGGER.warn("Failed to load dependency z for procedure AlienRootBoneMealGlobalBlockRightClicked!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CropsMod.LOGGER.warn("Failed to load dependency entity for procedure AlienRootBoneMealGlobalBlockRightClicked!");
			return;
		}
		...
		BlockState stage4 = Blocks.AIR.getDefaultState();
		BlockState stage5 = Blocks.AIR.getDefaultState();
		BlockState stage6 = Blocks.AIR.getDefaultState();
		BlockState stage7 = Blocks.AIR.getDefaultState();
		...
		if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem() == (itemBoneMeal)
				.getItem()) {
			...
			if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage0).getBlock()
					|| (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage1).getBlock()
					|| (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage2).getBlock()
					|| (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage3).getBlock()
					|| (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage4).getBlock()
					|| (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage5).getBlock()
					|| (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == (blockStage6).getBlock()) {
				if (!world.isRemote()) {
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
